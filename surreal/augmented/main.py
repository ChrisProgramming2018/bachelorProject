...
if __name__ == "__main__":
    ...
    parser.add_argument('--buffer_size', default=3e5, type=int)           # max trans in replaybuffer
    parser.add_argument('--save_model', default=True, type=bool)          # Boolean checker whether or not to save the pre-trained model
    parser.add_argument('--lr_actor', default=1e-4, type=float)           # learnin rate critic
    ...
    parser.add_argument('--target_update_freq', default=50, type=int)     # steps between the hardupdate critic
    ...
    parser.add_argument('--device', default='cuda', type=str)             # move data to gpu if cuda is available
    ...
    parser.add_argument('--history_length', default=3, type=int)          # amount of images for represent a state
    parser.add_argument('--image_pad', default=4, type=int)               # shift boundarie 4 pixel
    parser.add_argument('--last_states_actor', default=1e4, type=int)     # Idx for the replay buffer for the samples of the actor update
    parser.add_argument('--size', default=84, type=int,)                  # size of image
    ...
    parser.add_argument('--debug', default=False, type=bool)              # activate print of debugging
