...
def train_agent(args, param):
    ...
    pathname += "_actor_300_200_scale_reward_" + str(args.reward_scalling)
    ...
    replay_buffer = ReplayBuffer(obs_shape, action_shape, int(args.buffer_size), args.image_pad, args.device, args.last_states_actor)
    save_env_vid = False
    total_timesteps = 0
